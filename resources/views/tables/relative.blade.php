...
@section('content')
            ...
            <div class="bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
                <div class="mb-1 w-full">
                    <div class="mb-4">
                        ...
                        <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Manage relatives</h1>
                    </div>
                    <div class="sm:flex">
                ...
                <div class="overflow-x-auto">
                    <div class="align-middle inline-block min-w-full">
                        <div class="shadow overflow-hidden">
                            <table class="table-fixed min-w-full divide-y divide-gray-200" id = "relative_table">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200" id="relative_table_body">
                                    {{-- {{< users.inline >}} --}}
                ...
                <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                    ...
                    <div class="bg-white rounded-lg shadow relative">
                        ...
                        <div class="p-6 space-y-6">
                            <form id="update_relative_form" action="#" method="#" enctype="multipart/form-data">
                                {{-- @csrf --}}
                                <div class="grid grid-cols-6 gap-6">
                                    <input type="hidden" name="relative_id" id="edit_relative_id">
                        ...
                        <div class="items-center p-6 border-t border-gray-200 rounded-b">
                            <button
                                ...
                                type="submit"
                                id="update_relative_button">Save all</button>
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                    ...
                    <div class="bg-white rounded-lg shadow relative">
                        ...
                        <div class="p-6 pt-0 text-center">
                            ...
                            <a href="#" id="delete-relative-sure"
    ...
    @section('script')   
    <script src="{{url('/js/relative_table.js')}}"></script>
    @endsection
@endsection