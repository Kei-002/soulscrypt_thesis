...
@section('body')
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
                        ...
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SoulScrypt</span>
                    </a>
                </div>
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <div class="px-4 py-3" role="none">
                                <p class="text-sm text-gray-900 dark:text-white" role="none">
                                    Khen Christian Vargas
                                </p>
                                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                                    khenchristian.vargas@tup.edu.ph
                                </p>
                            </div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Plot Map</span>
                    </a>
                </li>
                ...
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">User List</span>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-5 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            {{-- Put Content Here --}}
            @yield('content')
        </div>
    </div>
