...
<div class="mx-auto md:h-screen flex flex-col justify-center items-center px-6pt:mt-0">
...
<form id="register_form" enctype="multipart/form-data">
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="tel" id="phonenum" name="phonenum" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required>
        </div>
    </div>
    <div class="mb-6">
    ...
    <button id="register_button" type="submit" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-base px-5 py-3 w-full sm:w-auto text-center">Create account</button>
